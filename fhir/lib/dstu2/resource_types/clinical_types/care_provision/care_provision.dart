...
class CarePlanRelatedPlan with _$CarePlanRelatedPlan {
  ...
  /// Factory constructor, accepts a [String] in YAML format as an argument
  factory CarePlanRelatedPlan.fromYaml(
    dynamic yaml,
    SerializationManager serializationManager,
  ) =>
      yaml is String
...
class CarePlanParticipant with _$CarePlanParticipant {
  ...
  /// Factory constructor, accepts a [String] in YAML format as an argument
  factory CarePlanParticipant.fromYaml(
    dynamic yaml,
    SerializationManager serializationManager,
  ) =>
      yaml is String
...
class CarePlanActivityDetail with _$CarePlanActivityDetail {
  ...
  /// Factory constructor, accepts a [String] in YAML format as an argument
  factory CarePlanActivityDetail.fromYaml(
    dynamic yaml,
    SerializationManager serializationManager,
  ) =>
      yaml is String
...
class ReferralRequest with Resource, _$ReferralRequest {
  ...
  /// Factory constructor, accepts a [String] in YAML format as an argument
  factory ReferralRequest.fromYaml(
    dynamic yaml,
    SerializationManager serializationManager,
  ) =>
      yaml is String
...
class ProcedureRequest with Resource, _$ProcedureRequest {
  ...
  /// Factory constructor, accepts a [String] in YAML format as an argument
  factory ProcedureRequest.fromYaml(
    dynamic yaml,
    SerializationManager serializationManager,
  ) =>
      yaml is String
...
class NutritionOrderOralDietNutrient with _$NutritionOrderOralDietNutrient {
  ...
  /// Factory constructor, accepts a [String] in YAML format as an argument
  factory NutritionOrderOralDietNutrient.fromYaml(
    dynamic yaml,
    SerializationManager serializationManager,
  ) =>
      yaml is String
...
class NutritionOrderOralDietTexture with _$NutritionOrderOralDietTexture {
  ...
  /// Factory constructor, accepts a [String] in YAML format as an argument
  factory NutritionOrderOralDietTexture.fromYaml(
    dynamic yaml,
    SerializationManager serializationManager,
  ) =>
      yaml is String
...
class NutritionOrderEnteralFormulaAdministration
  ...
  /// Factory constructor, accepts a [String] in YAML format as an argument
  factory NutritionOrderEnteralFormulaAdministration.fromYaml(
    dynamic yaml,
    SerializationManager serializationManager,
  ) =>
      yaml is String
...
class VisionPrescriptionDispense with _$VisionPrescriptionDispense {
  ...
  /// Factory constructor, accepts a [String] in YAML format as an argument
  factory VisionPrescriptionDispense.fromYaml(
    dynamic yaml,
    SerializationManager serializationManager,
  ) =>
      yaml is String
