...
class CapabilityStatementCertificate with _$CapabilityStatementCertificate {
  ...
  /// Factory constructor, accepts a [String] in YAML format as an argument
  factory CapabilityStatementCertificate.fromYaml(
    dynamic yaml,
    SerializationManager serializationManager,
  ) =>
      yaml is String
...
class CapabilityStatementEvent with _$CapabilityStatementEvent {
  ...
  /// Factory constructor, accepts a [String] in YAML format as an argument
  factory CapabilityStatementEvent.fromYaml(
    dynamic yaml,
    SerializationManager serializationManager,
  ) =>
      yaml is String
...
class DataElementMapping with _$DataElementMapping {
  ...
  /// Factory constructor, accepts a [String] in YAML format as an argument
  factory DataElementMapping.fromYaml(
    dynamic yaml,
    SerializationManager serializationManager,
  ) =>
      yaml is String
