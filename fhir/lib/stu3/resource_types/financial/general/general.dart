...
class ChargeItemParticipant with _$ChargeItemParticipant {
  ...
  /// Factory constructor, accepts a [String] in YAML format as an argument
  factory ChargeItemParticipant.fromYaml(
    dynamic yaml,
    SerializationManager serializationManager,
  ) =>
      yaml is String
...
class ContractAgent with _$ContractAgent {
  ...
  /// Factory constructor, accepts a [String] in YAML format as an argument
  factory ContractAgent.fromYaml(
    dynamic yaml,
    SerializationManager serializationManager,
  ) =>
      yaml is String
...
class ContractAgent1 with _$ContractAgent1 {
  ...
  /// Factory constructor, accepts a [String] in YAML format as an argument
  factory ContractAgent1.fromYaml(
    dynamic yaml,
    SerializationManager serializationManager,
  ) =>
      yaml is String
...
class ContractValuedItem1 with _$ContractValuedItem1 {
  ...
  /// Factory constructor, accepts a [String] in YAML format as an argument
  factory ContractValuedItem1.fromYaml(
    dynamic yaml,
    SerializationManager serializationManager,
  ) =>
      yaml is String
...
class ExplanationOfBenefitInformation with _$ExplanationOfBenefitInformation {
  ...
  /// Factory constructor, accepts a [String] in YAML format as an argument
  factory ExplanationOfBenefitInformation.fromYaml(
    dynamic yaml,
    SerializationManager serializationManager,
  ) =>
      yaml is String
