...
class CoverageGrouping with _$CoverageGrouping {
  ...
  /// Factory constructor, accepts a [String] in YAML format as an argument
  factory CoverageGrouping.fromYaml(
    dynamic yaml,
    SerializationManager serializationManager,
  ) =>
      yaml is String
...
class EligibilityRequest with Resource, _$EligibilityRequest {
  ...
  /// Factory constructor, accepts a [String] in YAML format as an argument
  factory EligibilityRequest.fromYaml(
    dynamic yaml,
    SerializationManager serializationManager,
  ) =>
      yaml is String
...
class EligibilityResponse with Resource, _$EligibilityResponse {
  ...
  /// Factory constructor, accepts a [String] in YAML format as an argument
  factory EligibilityResponse.fromYaml(
    dynamic yaml,
    SerializationManager serializationManager,
  ) =>
      yaml is String
...
class EligibilityResponseInsurance with _$EligibilityResponseInsurance {
  ...
  /// Factory constructor, accepts a [String] in YAML format as an argument
  factory EligibilityResponseInsurance.fromYaml(
    dynamic yaml,
    SerializationManager serializationManager,
  ) =>
      yaml is String
...
class EligibilityResponseBenefitBalance
  ...
  /// Factory constructor, accepts a [String] in YAML format as an argument
  factory EligibilityResponseBenefitBalance.fromYaml(
    dynamic yaml,
    SerializationManager serializationManager,
  ) =>
      yaml is String
...
class EligibilityResponseFinancial with _$EligibilityResponseFinancial {
  ...
  /// Factory constructor, accepts a [String] in YAML format as an argument
  factory EligibilityResponseFinancial.fromYaml(
    dynamic yaml,
    SerializationManager serializationManager,
  ) =>
      yaml is String
...
class EligibilityResponseError with _$EligibilityResponseError {
  ...
  /// Factory constructor, accepts a [String] in YAML format as an argument
  factory EligibilityResponseError.fromYaml(
    dynamic yaml,
    SerializationManager serializationManager,
  ) =>
      yaml is String
