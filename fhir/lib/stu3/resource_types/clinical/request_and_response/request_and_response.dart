...
class CommunicationRequestRequester with _$CommunicationRequestRequester {
  ...
  /// Factory constructor, accepts a [String] in YAML format as an argument
  factory CommunicationRequestRequester.fromYaml(
    dynamic yaml,
    SerializationManager serializationManager,
  ) =>
      yaml is String
...
class DeviceRequestRequester with _$DeviceRequestRequester {
  ...
  /// Factory constructor, accepts a [String] in YAML format as an argument
  factory DeviceRequestRequester.fromYaml(
    dynamic yaml,
    SerializationManager serializationManager,
  ) =>
      yaml is String
...
class SupplyRequestOrderedItem with _$SupplyRequestOrderedItem {
  ...
  /// Factory constructor, accepts a [String] in YAML format as an argument
  factory SupplyRequestOrderedItem.fromYaml(
    dynamic yaml,
    SerializationManager serializationManager,
  ) =>
      yaml is String
...
class SupplyRequestRequester with _$SupplyRequestRequester {
  ...
  /// Factory constructor, accepts a [String] in YAML format as an argument
  factory SupplyRequestRequester.fromYaml(
    dynamic yaml,
    SerializationManager serializationManager,
  ) =>
      yaml is String
