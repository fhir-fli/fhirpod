...
class ImmunizationPractitioner with _$ImmunizationPractitioner {
  ...
  /// Factory constructor, accepts a [String] in YAML format as an argument
  factory ImmunizationPractitioner.fromYaml(
    dynamic yaml,
    SerializationManager serializationManager,
  ) =>
      yaml is String
...
class ImmunizationRecommendationProtocol
  ...
  /// Factory constructor, accepts a [String] in YAML format as an argument
  factory ImmunizationRecommendationProtocol.fromYaml(
    dynamic yaml,
    SerializationManager serializationManager,
  ) =>
      yaml is String
...
class MedicationContent with _$MedicationContent {
  ...
  /// Factory constructor, accepts a [String] in YAML format as an argument
  factory MedicationContent.fromYaml(
    dynamic yaml,
    SerializationManager serializationManager,
  ) =>
      yaml is String
...
class MedicationRequestRequester with _$MedicationRequestRequester {
  ...
  /// Factory constructor, accepts a [String] in YAML format as an argument
  factory MedicationRequestRequester.fromYaml(
    dynamic yaml,
    SerializationManager serializationManager,
  ) =>
      yaml is String
