...
class ProcessRequest with Resource, _$ProcessRequest {
  ...
  /// Factory constructor, accepts a [String] in YAML format as an argument
  factory ProcessRequest.fromYaml(
    dynamic yaml,
    SerializationManager serializationManager,
  ) =>
      yaml is String
...
class ProcessRequestItem with _$ProcessRequestItem {
  ...
  /// Factory constructor, accepts a [String] in YAML format as an argument
  factory ProcessRequestItem.fromYaml(
    dynamic yaml,
    SerializationManager serializationManager,
  ) =>
      yaml is String
...
class ProcessResponse with Resource, _$ProcessResponse {
  ...
  /// Factory constructor, accepts a [String] in YAML format as an argument
  factory ProcessResponse.fromYaml(
    dynamic yaml,
    SerializationManager serializationManager,
  ) =>
      yaml is String
...
class ProcessResponseProcessNote with _$ProcessResponseProcessNote {
  ...
  /// Factory constructor, accepts a [String] in YAML format as an argument
  factory ProcessResponseProcessNote.fromYaml(
    dynamic yaml,
    SerializationManager serializationManager,
  ) =>
      yaml is String
...
class TaskRequester with _$TaskRequester {
  ...
  /// Factory constructor, accepts a [String] in YAML format as an argument
  factory TaskRequester.fromYaml(
    dynamic yaml,
    SerializationManager serializationManager,
  ) =>
      yaml is String
