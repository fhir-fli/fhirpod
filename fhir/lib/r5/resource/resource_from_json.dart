...
Resource _resourceFromJson(
  ...
  switch (resourceType) {
    ...
    case 'Endpoint':
      return Endpoint.fromJson(json, serializationManager);
    ...
    case 'List':
      return List_.fromJson(json, serializationManager);
    case 'Location':
    ...
    case 'MedicationUsage':
      return MedicationUsage.fromJson(json, serializationManager);
