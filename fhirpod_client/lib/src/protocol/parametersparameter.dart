...
class ParametersParameter extends _i1.SerializableEntity {
  ParametersParameter({
    this.fhirId,
    this.extension_,
  ...
  factory ParametersParameter.fromJson(
    ...
    return ParametersParameter(
      ...
      valueRatioRange: serializationManager
          .deserialize<_i2.RatioRange?>(jsonSerialization['valueRatioRange']),
      ...
      valueExtendedContactDetail:
          serializationManager.deserialize<_i2.ExtendedContactDetail?>(
              jsonSerialization['valueExtendedContactDetail']),
      ...
      resource: serializationManager
          .deserialize<_i2.Resource?>(jsonSerialization['resource']),
      part_: serializationManager.deserialize<List<_i2.ParametersParameter>?>(
  ...
  _i2.RatioRange? valueRatioRange;
  ...
  _i2.ExtendedContactDetail? valueExtendedContactDetail;

  _i2.Dosage? valueDosage;

  _i2.FhirMeta? valueMeta;

  _i2.Resource? resource;

  List<_i2.ParametersParameter>? part_;
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'valueExtendedContactDetail': valueExtendedContactDetail,
