...
class ClaimResponseDetail1 extends _i1.SerializableEntity {
  ...
  factory ClaimResponseDetail1.fromJson(
    ...
    return ClaimResponseDetail1(
      ...
      subDetail:
          serializationManager.deserialize<List<_i2.ClaimResponseSubDetail1>?>(
  ...
  List<_i2.ClaimResponseSubDetail1>? subDetail;
