...
class ElementDefinitionType extends _i1.SerializableEntity {
  ...
  factory ElementDefinitionType.fromJson(
    ...
    return ElementDefinitionType(
      ...
      aggregation:
          serializationManager.deserialize<ElementDefinitionTypeAggregation?>(
              jsonSerialization['aggregation']),
      aggregationElement: serializationManager.deserialize<List<_i2.Element>?>(
          jsonSerialization['aggregationElement']),
      versioning:
          serializationManager.deserialize<ElementDefinitionTypeVersioning?>(
              jsonSerialization['versioning']),
