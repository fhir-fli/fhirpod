...
class PermissionJustification extends _i1.SerializableEntity {
  ...
  factory PermissionJustification.fromJson(
    ...
    return PermissionJustification(
      ...
      evidence: serializationManager
          .deserialize<List<_i2.Reference>?>(jsonSerialization['evidence']),
    );
  }
