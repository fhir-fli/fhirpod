...
class TimingRepeat extends _i1.SerializableEntity {
  ...
  factory TimingRepeat.fromJson(
    ...
    return TimingRepeat(
      ...
      durationUnit: serializationManager.deserialize<TimingRepeatDurationUnit?>(
          jsonSerialization['durationUnit']),
      ...
      periodUnit: serializationManager.deserialize<TimingRepeatPeriodUnit?>(
          jsonSerialization['periodUnit']),
      ...
      dayOfWeek: serializationManager
          .deserialize<List<FhirCode>?>(jsonSerialization['dayOfWeek']),
      ...
      timeOfDay: serializationManager
          .deserialize<List<FhirTime>?>(jsonSerialization['timeOfDay']),
      ...
      when: serializationManager
          .deserialize<List<TimingRepeatWhen>?>(jsonSerialization['when']),
