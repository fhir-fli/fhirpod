...
class ChargeItemDefinition extends _i1.SerializableEntity {
  ...
  factory ChargeItemDefinition.fromJson(
    ...
    return ChargeItemDefinition(
      ...
      partOf: serializationManager
          .deserialize<List<FhirCanonical>?>(jsonSerialization['partOf']),
      replaces: serializationManager
          .deserialize<List<FhirCanonical>?>(jsonSerialization['replaces']),
      code: serializationManager
          .deserialize<_i2.CodeableConcept?>(jsonSerialization['code']),
      instance: serializationManager
          .deserialize<List<_i2.Reference>?>(jsonSerialization['instance']),
      applicability: serializationManager
          .deserialize<List<_i2.ChargeItemDefinitionApplicability>?>(
              jsonSerialization['applicability']),
      propertyGroup: serializationManager
          .deserialize<List<_i2.ChargeItemDefinitionPropertyGroup>?>(
              jsonSerialization['propertyGroup']),
    );
  }
  ...
  List<_i2.Reference>? instance;

  List<_i2.ChargeItemDefinitionApplicability>? applicability;

  List<_i2.ChargeItemDefinitionPropertyGroup>? propertyGroup;
