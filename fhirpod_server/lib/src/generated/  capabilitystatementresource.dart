...
class CapabilityStatementResource extends _i1.SerializableEntity {
  ...
  factory CapabilityStatementResource.fromJson(
    ...
    return CapabilityStatementResource(
      ...
      supportedProfile: serializationManager.deserialize<List<FhirCanonical>?>(
          jsonSerialization['supportedProfile']),
      ...
      referencePolicy: serializationManager
          .deserialize<List<FhirCode>?>(jsonSerialization['referencePolicy']),
