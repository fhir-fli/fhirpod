...
class TestScript extends _i1.TableRow {
  TestScript({
    int? id,
  ...
  factory TestScript.fromJson(
    ...
    return TestScript(
      ...
      origin: serializationManager.deserialize<List<_i2.TestScriptOrigin>?>(
          jsonSerialization['origin']),
      destination:
          serializationManager.deserialize<List<_i2.TestScriptDestination>?>(
              jsonSerialization['destination']),
      metadata: serializationManager
          .deserialize<_i2.TestScriptMetadata?>(jsonSerialization['metadata']),
      scope: serializationManager
          .deserialize<List<_i2.TestScriptScope>?>(jsonSerialization['scope']),
      fixture: serializationManager.deserialize<List<_i2.TestScriptFixture>?>(
          jsonSerialization['fixture']),
      profile: serializationManager
          .deserialize<List<String>?>(jsonSerialization['profile']),
      variable: serializationManager.deserialize<List<_i2.TestScriptVariable>?>(
          jsonSerialization['variable']),
      setup: serializationManager
          .deserialize<_i2.TestScriptSetup?>(jsonSerialization['setup']),
      test: serializationManager
          .deserialize<List<_i2.TestScriptTest>?>(jsonSerialization['test']),
      teardown: serializationManager
          .deserialize<_i2.TestScriptTeardown?>(jsonSerialization['teardown']),
    );
  }

  static final t = TestScriptTable();
  ...
  List<_i2.TestScriptOrigin>? origin;

  List<_i2.TestScriptDestination>? destination;

  _i2.TestScriptMetadata? metadata;

  List<_i2.TestScriptScope>? scope;

  List<_i2.TestScriptFixture>? fixture;

  List<String>? profile;

  List<_i2.TestScriptVariable>? variable;

  _i2.TestScriptSetup? setup;

  List<_i2.TestScriptTest>? test;

  _i2.TestScriptTeardown? teardown;
