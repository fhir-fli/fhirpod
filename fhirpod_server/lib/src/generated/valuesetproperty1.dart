...
class ValueSetProperty1 extends _i1.SerializableEntity {
  ValueSetProperty1({
    this.id,
    this.extension_,
  ...
  factory ValueSetProperty1.fromJson(
    ...
    return ValueSetProperty1(
      ...
      subProperty:
          serializationManager.deserialize<List<_i2.ValueSetSubProperty>?>(
              jsonSerialization['subProperty']),
    );
  }
  ...
  List<_i2.ValueSetSubProperty>? subProperty;
