  ...
  factory ElementDefinition.fromJson(
    ...
    return ElementDefinition(
      ...
      representation: serializationManager
          .deserialize<List<String>?>(jsonSerialization['representation']),
      ...
      condition: serializationManager
          .deserialize<List<String>?>(jsonSerialization['condition']),
      ...
      valueAlternatives: serializationManager
          .deserialize<List<String>?>(jsonSerialization['valueAlternatives']),
