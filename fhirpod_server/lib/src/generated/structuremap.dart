...
class StructureMap extends _i1.TableRow {
  StructureMap({
    int? id,
  ...
  factory StructureMap.fromJson(
    ...
    return StructureMap(
      ...
      structure:
          serializationManager.deserialize<List<_i2.StructureMapStructure>?>(
              jsonSerialization['structure']),
      import_: serializationManager
          .deserialize<List<String>?>(jsonSerialization['import_']),
      const_: serializationManager.deserialize<List<_i2.StructureMapConst>?>(
          jsonSerialization['const_']),
      group: serializationManager
          .deserialize<List<_i2.StructureMapGroup>>(jsonSerialization['group']),
    );
  }

  static final t = StructureMapTable();
  ...
  List<_i2.StructureMapStructure>? structure;

  List<String>? import_;

  List<_i2.StructureMapConst>? const_;

  List<_i2.StructureMapGroup> group;
