...
class InsurancePlanSpecificCost extends _i1.SerializableEntity {
  ...
  factory InsurancePlanSpecificCost.fromJson(
    ...
    return InsurancePlanSpecificCost(
      ...
      benefit:
          serializationManager.deserialize<List<_i2.InsurancePlanBenefit1>?>(
  ...
  List<_i2.InsurancePlanBenefit1>? benefit;
