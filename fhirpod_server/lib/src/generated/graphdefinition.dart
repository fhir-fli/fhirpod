...
class GraphDefinition extends _i1.TableRow {
  GraphDefinition({
    int? id,
  ...
  factory GraphDefinition.fromJson(
    ...
    return GraphDefinition(
      ...
      start:
          serializationManager.deserialize<String?>(jsonSerialization['start']),
      startElement: serializationManager
          .deserialize<_i2.Element?>(jsonSerialization['startElement']),
      node: serializationManager.deserialize<List<_i2.GraphDefinitionNode>?>(
          jsonSerialization['node']),
      link: serializationManager.deserialize<List<_i2.GraphDefinitionLink>?>(
          jsonSerialization['link']),
    );
  }

  static final t = GraphDefinitionTable();
  ...
  List<_i2.GraphDefinitionNode>? node;

  List<_i2.GraphDefinitionLink>? link;
...
class GraphDefinitionTable extends _i1.Table {
  ...
  final start = _i1.ColumnString('start');
