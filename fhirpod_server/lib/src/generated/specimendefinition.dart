...
class SpecimenDefinition extends _i1.TableRow {
  ...
  factory SpecimenDefinition.fromJson(
    ...
    return SpecimenDefinition(
      ...
      typeCollected: serializationManager.deserialize<_i2.CodeableConcept?>(
          jsonSerialization['typeCollected']),
      patientPreparation:
          serializationManager.deserialize<List<_i2.CodeableConcept>?>(
              jsonSerialization['patientPreparation']),
      timeAspect: serializationManager
          .deserialize<String?>(jsonSerialization['timeAspect']),
      timeAspectElement: serializationManager
          .deserialize<_i2.Element?>(jsonSerialization['timeAspectElement']),
      collection: serializationManager.deserialize<List<_i2.CodeableConcept>?>(
          jsonSerialization['collection']),
      typeTested: serializationManager
          .deserialize<List<_i2.SpecimenDefinitionTypeTested>?>(
              jsonSerialization['typeTested']),
    );
  }

  static final t = SpecimenDefinitionTable();
  ...
  _i2.CodeableConcept? typeCollected;

  List<_i2.CodeableConcept>? patientPreparation;

  String? timeAspect;

  _i2.Element? timeAspectElement;

  List<_i2.CodeableConcept>? collection;

  List<_i2.SpecimenDefinitionTypeTested>? typeTested;
  ...
  void setColumn(
    ...
    switch (columnName) {
      ...
      case 'derivedFromUri':
        ...
        return;
      case 'derivedFromUriElement':
        derivedFromUriElement = value;
        return;
      ...
      case 'timeAspect':
        timeAspect = value;
        return;
      case 'timeAspectElement':
        timeAspectElement = value;
        return;
      case 'collection':
        collection = value;
        return;
...
class SpecimenDefinitionTable extends _i1.Table {
  ...
  final timeAspect = _i1.ColumnString('timeAspect');
