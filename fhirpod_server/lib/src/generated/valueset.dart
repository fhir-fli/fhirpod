...
class ValueSet extends _i1.TableRow {
  ValueSet({
    int? id,
  ...
  factory ValueSet.fromJson(
    ...
    return ValueSet(
      ...
      immutable: serializationManager
          .deserialize<bool?>(jsonSerialization['immutable']),
      immutableElement: serializationManager
          .deserialize<_i2.Element?>(jsonSerialization['immutableElement']),
      compose: serializationManager
          .deserialize<_i2.ValueSetCompose?>(jsonSerialization['compose']),
      expansion: serializationManager
          .deserialize<_i2.ValueSetExpansion?>(jsonSerialization['expansion']),
      scope: serializationManager
          .deserialize<_i2.ValueSetScope?>(jsonSerialization['scope']),
    );
  }

  static final t = ValueSetTable();
  ...
  _i2.Element? immutableElement;

  _i2.ValueSetCompose? compose;

  _i2.ValueSetExpansion? expansion;

  _i2.ValueSetScope? scope;
  ...
  void setColumn(
    ...
    switch (columnName) {
      ...
      case 'immutable':
        immutable = value;
        return;
      case 'immutableElement':
        immutableElement = value;
        return;
      case 'compose':
        compose = value;
        return;
...
class ValueSetTable extends _i1.Table {
  ...
  final immutable = _i1.ColumnBool('immutable');
