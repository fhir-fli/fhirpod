  ...
  factory CapabilityStatement.fromJson(
    ...
    return CapabilityStatement(
      ...
      instantiates: serializationManager
          .deserialize<List<FhirCanonical>?>(jsonSerialization['instantiates']),
      imports: serializationManager
          .deserialize<List<FhirCanonical>?>(jsonSerialization['imports']),
      software:
      ...
      format: serializationManager
          .deserialize<List<FhirCode>?>(jsonSerialization['format']),
      ...
      patchFormat: serializationManager
          .deserialize<List<FhirCode>?>(jsonSerialization['patchFormat']),
      ...
      acceptLanguage: serializationManager
          .deserialize<List<FhirCode>?>(jsonSerialization['acceptLanguage']),
      ...
      implementationGuide:
          serializationManager.deserialize<List<FhirCanonical>?>(
              jsonSerialization['implementationGuide']),
      rest:
