...
class EvidenceVariable extends _i1.TableRow {
  EvidenceVariable({
    int? id,
  ...
  factory EvidenceVariable.fromJson(
    ...
    return EvidenceVariable(
      ...
      shortTitle: serializationManager
          .deserialize<String?>(jsonSerialization['shortTitle']),
      shortTitleElement: serializationManager
          .deserialize<_i2.Element?>(jsonSerialization['shortTitleElement']),
      ...
      handling: serializationManager
          .deserialize<String?>(jsonSerialization['handling']),
      handlingElement: serializationManager
          .deserialize<_i2.Element?>(jsonSerialization['handlingElement']),
      category:
          serializationManager.deserialize<List<_i2.EvidenceVariableCategory>?>(
              jsonSerialization['category']),
    );
  }

  static final t = EvidenceVariableTable();
  ...
  _i2.Element? handlingElement;

  List<_i2.EvidenceVariableCategory>? category;
  ...
  void setColumn(
    ...
    switch (columnName) {
      ...
      case 'shortTitle':
        shortTitle = value;
        return;
      case 'shortTitleElement':
        shortTitleElement = value;
        return;
      case 'note':
        note = value;
        return;
