...
class ConditionDefinition extends _i1.TableRow {
  ...
  factory ConditionDefinition.fromJson(
    ...
    return ConditionDefinition(
      ...
      stage: serializationManager
          .deserialize<_i2.CodeableConcept?>(jsonSerialization['stage']),
      hasSeverity: serializationManager
          .deserialize<bool?>(jsonSerialization['hasSeverity']),
      hasSeverityElement: serializationManager
          .deserialize<_i2.Element?>(jsonSerialization['hasSeverityElement']),
      hasBodySite: serializationManager
          .deserialize<bool?>(jsonSerialization['hasBodySite']),
      hasBodySiteElement: serializationManager
          .deserialize<_i2.Element?>(jsonSerialization['hasBodySiteElement']),
      hasStage: serializationManager
          .deserialize<bool?>(jsonSerialization['hasStage']),
      hasStageElement: serializationManager
          .deserialize<_i2.Element?>(jsonSerialization['hasStageElement']),
      definition: serializationManager
          .deserialize<List<String>?>(jsonSerialization['definition']),
      definitionElement: serializationManager.deserialize<List<_i2.Element>?>(
          jsonSerialization['definitionElement']),
      observation: serializationManager
          .deserialize<List<_i2.ConditionDefinitionObservation>?>(
              jsonSerialization['observation']),
      medication: serializationManager
          .deserialize<List<_i2.ConditionDefinitionMedication>?>(
              jsonSerialization['medication']),
      precondition: serializationManager
          .deserialize<List<_i2.ConditionDefinitionPrecondition>?>(
              jsonSerialization['precondition']),
      team: serializationManager
          .deserialize<List<_i2.Reference>?>(jsonSerialization['team']),
      questionnaire: serializationManager
          .deserialize<List<_i2.ConditionDefinitionQuestionnaire>?>(
              jsonSerialization['questionnaire']),
      plan:
          serializationManager.deserialize<List<_i2.ConditionDefinitionPlan>?>(
              jsonSerialization['plan']),
    );
  }

  static final t = ConditionDefinitionTable();
  ...
  _i2.CodeableConcept? stage;

  bool? hasSeverity;

  _i2.Element? hasSeverityElement;

  bool? hasBodySite;

  _i2.Element? hasBodySiteElement;

  bool? hasStage;

  _i2.Element? hasStageElement;

  List<String>? definition;

  List<_i2.Element>? definitionElement;

  List<_i2.ConditionDefinitionObservation>? observation;

  List<_i2.ConditionDefinitionMedication>? medication;

  List<_i2.ConditionDefinitionPrecondition>? precondition;

  List<_i2.Reference>? team;

  List<_i2.ConditionDefinitionQuestionnaire>? questionnaire;

  List<_i2.ConditionDefinitionPlan>? plan;
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'hasSeverityElement': hasSeverityElement,
      'hasBodySite': hasBodySite,
      'hasBodySiteElement': hasBodySiteElement,
      'hasStage': hasStage,
      'hasStageElement': hasStageElement,
  ...
  void setColumn(
    ...
    switch (columnName) {
      ...
      case 'hasSeverity':
        hasSeverity = value;
        return;
      case 'hasSeverityElement':
        hasSeverityElement = value;
        return;
      case 'hasBodySite':
        hasBodySite = value;
        return;
      case 'hasBodySiteElement':
        hasBodySiteElement = value;
        return;
      case 'hasStage':
        hasStage = value;
        return;
      case 'hasStageElement':
        hasStageElement = value;
        return;
      case 'definition':
        definition = value;
        return;
