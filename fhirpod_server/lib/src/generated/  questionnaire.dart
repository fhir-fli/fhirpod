...
class Questionnaire extends _i1.SerializableEntity {
  Questionnaire({
  ...
  factory Questionnaire.fromJson(
    ...
    return Questionnaire(
      ...
      derivedFrom: serializationManager
          .deserialize<List<FhirCanonical>?>(jsonSerialization['derivedFrom']),
      subjectType: serializationManager
          .deserialize<List<FhirCode>?>(jsonSerialization['subjectType']),
      subjectTypeElement: serializationManager.deserialize<List<_i2.Element>?>(
          jsonSerialization['subjectTypeElement']),
  ...
  List<_i2.Element>? subjectTypeElement;
