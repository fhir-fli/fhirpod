...
class NamingSystem extends _i1.TableRow {
  NamingSystem({
    int? id,
  ...
  factory NamingSystem.fromJson(
    ...
    return NamingSystem(
      ...
      responsible: serializationManager
          .deserialize<String?>(jsonSerialization['responsible']),
      ...
      uniqueId:
          serializationManager.deserialize<List<_i2.NamingSystemUniqueId>>(
              jsonSerialization['uniqueId']),
    );
  }

  static final t = NamingSystemTable();
  ...
  List<_i2.NamingSystemUniqueId> uniqueId;
...
class NamingSystemTable extends _i1.Table {
  ...
  final responsible = _i1.ColumnString('responsible');
