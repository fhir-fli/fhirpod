...
class ActivityDefinition extends _i1.TableRow {
  ...
  factory ActivityDefinition.fromJson(
    ...
    return ActivityDefinition(
      ...
      participant: serializationManager
          .deserialize<List<_i2.ActivityDefinitionParticipant>?>(
      ...
      productCodeableConcept:
          serializationManager.deserialize<_i2.CodeableConcept?>(
              jsonSerialization['productCodeableConcept']),
      ...
      specimenRequirement: serializationManager
          .deserialize<List<String>?>(jsonSerialization['specimenRequirement']),
      observationRequirement: serializationManager.deserialize<List<String>?>(
          jsonSerialization['observationRequirement']),
      observationResultRequirement:
          serializationManager.deserialize<List<String>?>(
              jsonSerialization['observationResultRequirement']),
      transform: serializationManager
          .deserialize<String?>(jsonSerialization['transform']),
      dynamicValue: serializationManager
          .deserialize<List<_i2.ActivityDefinitionDynamicValue>?>(
              jsonSerialization['dynamicValue']),
    );
  }

  static final t = ActivityDefinitionTable();
  ...
  List<_i2.ActivityDefinitionParticipant>? participant;

  _i2.Reference? productReference;

  _i2.CodeableConcept? productCodeableConcept;
  ...
  List<String>? specimenRequirement;

  List<String>? observationRequirement;

  List<String>? observationResultRequirement;

  String? transform;

  List<_i2.ActivityDefinitionDynamicValue>? dynamicValue;
...
class ActivityDefinitionTable extends _i1.Table {
  ...
  final timingDuration = _i1.ColumnString('timingDuration');
  ...
  final transform = _i1.ColumnString('transform');
