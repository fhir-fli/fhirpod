...
class ConceptMap extends _i1.SerializableEntity {
  ...
  factory ConceptMap.fromJson(
    ...
    return ConceptMap(
      ...
      property: serializationManager.deserialize<List<_i2.ConceptMapProperty>?>(
          jsonSerialization['property']),
      additionalAttribute: serializationManager
          .deserialize<List<_i2.ConceptMapAdditionalAttribute>?>(
              jsonSerialization['additionalAttribute']),
      sourceScopeUri: serializationManager
          .deserialize<String?>(jsonSerialization['sourceScopeUri']),
      sourceScopeUriElement: serializationManager.deserialize<_i2.Element?>(
          jsonSerialization['sourceScopeUriElement']),
      sourceScopeCanonical: serializationManager
          .deserialize<String?>(jsonSerialization['sourceScopeCanonical']),
      sourceScopeCanonicalElement:
          serializationManager.deserialize<_i2.Element?>(
              jsonSerialization['sourceScopeCanonicalElement']),
      targetScopeUri: serializationManager
          .deserialize<String?>(jsonSerialization['targetScopeUri']),
      targetScopeUriElement: serializationManager.deserialize<_i2.Element?>(
          jsonSerialization['targetScopeUriElement']),
      targetScopeCanonical: serializationManager
          .deserialize<String?>(jsonSerialization['targetScopeCanonical']),
      targetScopeCanonicalElement:
          serializationManager.deserialize<_i2.Element?>(
              jsonSerialization['targetScopeCanonicalElement']),
      group: serializationManager
          .deserialize<List<_i2.ConceptMapGroup>?>(jsonSerialization['group']),
    );
  }
  ...
  List<_i2.ConceptMapProperty>? property;

  List<_i2.ConceptMapAdditionalAttribute>? additionalAttribute;

  String? sourceScopeUri;

  _i2.Element? sourceScopeUriElement;

  String? sourceScopeCanonical;

  _i2.Element? sourceScopeCanonicalElement;

  String? targetScopeUri;

  _i2.Element? targetScopeUriElement;

  String? targetScopeCanonical;

  _i2.Element? targetScopeCanonicalElement;
