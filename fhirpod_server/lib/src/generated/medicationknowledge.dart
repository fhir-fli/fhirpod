...
class MedicationKnowledge extends _i1.TableRow {
  ...
  static final t = MedicationKnowledgeTable();
  ...
  void setColumn(
    ...
    switch (columnName) {
      ...
      case 'preparationInstruction':
        ...
        return;
      case 'preparationInstructionElement':
        preparationInstructionElement = value;
        return;
      case 'cost':
        cost = value;
        return;
...
class MedicationKnowledgeTable extends _i1.Table {
  ...
  final preparationInstruction = _i1.ColumnString('preparationInstruction');
