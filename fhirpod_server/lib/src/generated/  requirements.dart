...
class Requirements extends _i1.SerializableEntity {
  Requirements({
  ...
  factory Requirements.fromJson(
    ...
    return Requirements(
      ...
      actor: serializationManager
          .deserialize<List<FhirCanonical>?>(jsonSerialization['actor']),
      statement:
          serializationManager.deserialize<List<_i2.RequirementsStatement>?>(
              jsonSerialization['statement']),
    );
  }
  ...
  List<_i2.RequirementsStatement>? statement;
