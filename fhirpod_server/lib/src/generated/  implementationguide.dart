...
class ImplementationGuide extends _i1.SerializableEntity {
  ImplementationGuide({
  ...
  factory ImplementationGuide.fromJson(
    ...
    return ImplementationGuide(
      ...
      license: serializationManager
          .deserialize<String?>(jsonSerialization['license']),
      licenseElement: serializationManager
          .deserialize<_i2.Element?>(jsonSerialization['licenseElement']),
      fhirVersion: serializationManager
          .deserialize<List<FhirCode>?>(jsonSerialization['fhirVersion']),
      ...
      dependsOn: serializationManager
          .deserialize<List<_i2.ImplementationGuideDependsOn>?>(
              jsonSerialization['dependsOn']),
      global: serializationManager.deserialize<
          List<_i2.ImplementationGuideGlobal>?>(jsonSerialization['global']),
      definition:
          serializationManager.deserialize<_i2.ImplementationGuideDefinition?>(
              jsonSerialization['definition']),
      manifest:
          serializationManager.deserialize<_i2.ImplementationGuideManifest?>(
              jsonSerialization['manifest']),
    );
  }
  ...
  _i2.Element? licenseElement;

  List<FhirCode>? fhirVersion;

  List<_i2.Element>? fhirVersionElement;

  List<_i2.ImplementationGuideDependsOn>? dependsOn;

  List<_i2.ImplementationGuideGlobal>? global;

  _i2.ImplementationGuideDefinition? definition;

  _i2.ImplementationGuideManifest? manifest;
