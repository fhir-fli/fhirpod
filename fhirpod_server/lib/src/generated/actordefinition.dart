...
class ActorDefinition extends _i1.TableRow {
  ActorDefinition({
    int? id,
  ...
  static final t = ActorDefinitionTable();
...
class ActorDefinitionTable extends _i1.Table {
  ...
  final documentation = _i1.ColumnString('documentation');
  ...
  final capabilities = _i1.ColumnString('capabilities');
