...
client.QuestionnaireResponseAnswer questionnaireresponseansweruestionnaireResponseAnswerToServer(server.QuestionnaireResponseAnswer resource) => client.QuestionnaireResponseAnswer(
