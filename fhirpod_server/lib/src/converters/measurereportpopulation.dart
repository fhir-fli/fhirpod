...
client.MeasureReportPopulation measurereportpopulationeasureReportPopulationToServer(server.MeasureReportPopulation resource) => client.MeasureReportPopulation(
