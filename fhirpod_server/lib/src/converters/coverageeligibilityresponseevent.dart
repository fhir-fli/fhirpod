...
client.CoverageEligibilityResponseEvent coverageeligibilityresponseeventoverageEligibilityResponseEventToServer(server.CoverageEligibilityResponseEvent resource) => client.CoverageEligibilityResponseEvent(
