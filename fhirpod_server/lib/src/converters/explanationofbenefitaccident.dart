...
client.ExplanationOfBenefitAccident explanationofbenefitaccidentxplanationOfBenefitAccidentToServer(server.ExplanationOfBenefitAccident resource) => client.ExplanationOfBenefitAccident(
