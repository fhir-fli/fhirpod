...
client.CapabilityStatementInteraction capabilitystatementinteractionapabilityStatementInteractionToServer(server.CapabilityStatementInteraction resource) => client.CapabilityStatementInteraction(
