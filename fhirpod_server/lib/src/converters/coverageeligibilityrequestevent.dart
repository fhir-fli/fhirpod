...
client.CoverageEligibilityRequestEvent coverageeligibilityrequesteventoverageEligibilityRequestEventToServer(server.CoverageEligibilityRequestEvent resource) => client.CoverageEligibilityRequestEvent(
