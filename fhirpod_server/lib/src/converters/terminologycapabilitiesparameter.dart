...
client.TerminologyCapabilitiesParameter terminologycapabilitiesparametererminologyCapabilitiesParameterToServer(server.TerminologyCapabilitiesParameter resource) => client.TerminologyCapabilitiesParameter(
