...
client.DeviceDefinitionProperty devicedefinitionpropertyeviceDefinitionPropertyToServer(server.DeviceDefinitionProperty resource) => client.DeviceDefinitionProperty(
