...
client.CommunicationRequestPayload communicationrequestpayloadommunicationRequestPayloadToServer(server.CommunicationRequestPayload resource) => client.CommunicationRequestPayload(
