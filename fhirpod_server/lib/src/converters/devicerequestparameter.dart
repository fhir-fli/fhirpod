...
client.DeviceRequestParameter devicerequestparametereviceRequestParameterToServer(server.DeviceRequestParameter resource) => client.DeviceRequestParameter(
