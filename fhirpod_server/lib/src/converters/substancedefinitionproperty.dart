...
client.SubstanceDefinitionProperty substancedefinitionpropertyubstanceDefinitionPropertyToServer(server.SubstanceDefinitionProperty resource) => client.SubstanceDefinitionProperty(
