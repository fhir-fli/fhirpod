...
client.RequestOrchestrationInput requestorchestrationinputequestOrchestrationInputToServer(server.RequestOrchestrationInput resource) => client.RequestOrchestrationInput(
