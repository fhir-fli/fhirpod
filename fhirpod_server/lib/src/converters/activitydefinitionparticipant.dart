...
client.ActivityDefinitionParticipant activitydefinitionparticipantctivityDefinitionParticipantToServer(server.ActivityDefinitionParticipant resource) => client.ActivityDefinitionParticipant(
