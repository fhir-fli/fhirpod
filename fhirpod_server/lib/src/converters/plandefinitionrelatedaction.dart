...
client.PlanDefinitionRelatedAction plandefinitionrelatedactionlanDefinitionRelatedActionToServer(server.PlanDefinitionRelatedAction resource) => client.PlanDefinitionRelatedAction(
